...
3. Crie um arquivo CLAUDE.md na raiz explicando a arquitetura para as próximas sessões
...
- O `CLAUDE.md` gerado vai ser a memória do projeto para sessões futuras
