...
description: "Selecionar e aplicar os prompts migrados de prompts-codex-na-pratica quando o usuário pedir um fluxo coberto por esta coleção. Não usar como substituto de uma skill mais específica já disponível."
---
...
- `00-leia-primeiro.md` — 10 Prompts Essenciais — Codex na Prática
- `01-arquitetura.md` — Prompt 01 — ARQUITETURA
- `02-banco.md` — Prompt 02 — BANCO
- `03-auth.md` — Prompt 03 — AUTH
- `04-ui-ux.md` — Prompt 04 — UI/UX
- `05-integracao.md` — Prompt 05 — INTEGRAÇÃO
- `06-debug.md` — Prompt 06 — DEBUG
- `07-deploy.md` — Prompt 07 — DEPLOY
- `08-testes.md` — Prompt 08 — TESTES
- `09-refactor.md` — Prompt 09 — REFACTOR
- `10-docs.md` — Prompt 10 — DOCS
